...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-start rounded-lg bg-neutral-100 p-1 text-neutral-500 border border-neutral-200/60",
      className,
    )}
    {...props}
  />
